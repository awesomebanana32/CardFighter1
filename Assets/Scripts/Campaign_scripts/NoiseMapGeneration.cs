/*
    ...
    by 8coolguy
    Code was taken from previous project.
    https://github.com/8coolguy/pcg-solar-system/blob/master/Assets/Scripts/NoiseMapGeneration.cs
...
{
    public static float[,] GenerateNoiseMap(int mapHeight, int mapWidth, float scale, float offsetX, float offsetZ, Wave[] waves)
    {
